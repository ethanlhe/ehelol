...
const Index = () => {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <main className={`min-h-screen px-8 md:px-16 flex items-center justify-center transition-colors duration-300 ${theme === "dark" ? "bg-[#111111] text-white" : "bg-[#F5F5F5] text-black"}`}>
        <div className="relative w-full max-w-[1200px]">
          <div className="absolute left-0 top-[208px] -translate-x-[calc(100%+8px)] w-[calc((100%-8px)/3)] h-[135px] hidden md:block">
